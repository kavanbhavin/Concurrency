...
int main (void) {
	WDTCTL = WDTPW + WDTHOLD;
 	...
 	process_create(pD, 10);
 	process_create(pE,10);
 	process_create(pF,10);
 	process_create(pG,10);
 	process_create(pH,10);
 	process_create(pI,10);
 	process_create(pJ,10);
 	process_create(pK,10);
 	process_create(pL,10);
 	process_create(pM,10);
 	process_create(pN,10);
 	process_create(pO,10);
 	process_create(pP,10);
 	process_create(pQ,10);
 	process_create(pR,10);
 	process_create(pS,10);
